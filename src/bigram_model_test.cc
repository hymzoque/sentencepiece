...
class BigramModelTest : public test::TestWithParam<EncoderVersion> {
 protected:
...
TEST(BigramModelTest, SetBigramModelTest) {
...
TEST_P(BigramModelTest, PieceToIdTest) {
  ModelProto model_proto = MakeBaseModelProto();
...
TEST_P(BigramModelTest, PopulateNodesAllUnknownsTest) {
  ModelProto model_proto = MakeBaseModelProto();
...
TEST_P(BigramModelTest, PopulateNodesTest) {
  ModelProto model_proto = MakeBaseModelProto();
...
TEST_P(BigramModelTest, PopulateNodesWithUnusedTest) {
  ModelProto model_proto = MakeBaseModelProto();
...
TEST_P(BigramModelTest, ModelNBestTest) {
  ModelProto model_proto = MakeBaseModelProto();
...
TEST_P(BigramModelTest, EncodeTest) {
  ModelProto model_proto = MakeBaseModelProto();
...
TEST_P(BigramModelTest, EncodeWithUnusedTest) {
  ModelProto model_proto = MakeBaseModelProto();
...

  {
    ...
    // Bigram language model simply finds the best path without unused nodes.
    model_proto.mutable_pieces(3)->set_type(ModelProto::SentencePiece::UNUSED);
...
TEST_P(BigramModelTest, VerifyOutputsEquivalent) {
  ModelProto model_proto = MakeBaseModelProto();
...
INSTANTIATE_TEST_SUITE_P(ParametrizedBigramModelTests, BigramModelTest,
